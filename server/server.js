...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "data:", "https://logo.clearbit.com", "https://res.cloudinary.com"],
      connectSrc: ["'self'", "https://generativelanguage.googleapis.com", "http://localhost:5000", "http://localhost:5173"]
    }
  }
}));
